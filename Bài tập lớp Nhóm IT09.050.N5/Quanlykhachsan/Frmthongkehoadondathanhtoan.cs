...
{
    public partial class Frmthongkehoadondathanhtoan : Form
    {
        public Frmthongkehoadondathanhtoan()
        {
            InitializeComponent();
        }
        private string connectionString = "Data Source=ADMIN-PC\\TAN;Initial Catalog=doanqlks;Integrated Security=True";

        private void Frmthongkehoadondathanhtoan_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //gọi thủ tục từ SQL
                da.SelectCommand.CommandText = "thongkethongtinhoadondathanhtoan";
